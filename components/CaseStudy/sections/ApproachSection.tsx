    ...
    <>
      ...
      <div id="approach-section" className="space-y-6 md:space-y-8 mb-16">
        {images.map((image, index) => (
          <div
            key={index}
            className={`relative w-full ${index === 0 ? 'aspect-[16/9] md:aspect-[16/7]' : 'aspect-[16/9] md:aspect-[16/10]'} bg-bg-gray rounded-xl overflow-hidden flex items-center justify-center`}
          >
            {image ? (
              <img
                src={image}
