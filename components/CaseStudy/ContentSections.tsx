    ...
    <>
      ...
      <div className="relative">
        ...
        <div className="max-w-2xl mb-24">
          <h3 className="text-xl font-semibold text-primary-1 mb-6 font-family-inter">
            {caseStudy.businessGoal.title}
          </h3>
          <h2 className="text-4xl font-regular text-primary-1 mb-7 font-family-inter leading-tight">
